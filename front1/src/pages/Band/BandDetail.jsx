...
export default function BandDetail() {
  ...
  async function onDelete() {
    ...
    try {
      const res = await fetch(
        `${API.BASE}/api/bands/deleteBand/${id}`,
  ...
  if (!band) return <div className="p-6 text-center text-gray-500">ไม่พบข้อมูล</div>;
      ...
      <div className="mx-auto max-w-5xl">
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              ...
              {band.created_at ? new Date(band.created_at).toLocaleDateString("th-TH") : "-"}
            </p>
          </div>
        ...
        <div className="mb-8 rounded-2xl bg-white p-6 shadow">
          ...
          <p className="text-gray-700">
            {band.description || "ไม่มีคำอธิบาย"}
          </p>
        </div>

        <div className="rounded-2xl bg-white p-6 shadow">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">ตารางซ้อม / แสดง</h2>
